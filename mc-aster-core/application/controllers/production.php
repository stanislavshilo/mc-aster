...
class Production extends AC_Controller {
    ...
    public function Tayna_Tibeta() {
        ...
        $page_data = array(
            'title'							=> 'Биоактивный экстракт Тайна Тибета',
            'description'					=> 'Главное достоинство экстракта Тайна Тибета заключается в том, что он является системным регулятором, то есть способствует комплексному оздоровлению организма и восстановлению функциональной активности всех его органов и систем.',
        ...
        $this->load->view("production/tayna_tibeta", $page_data);
    }
